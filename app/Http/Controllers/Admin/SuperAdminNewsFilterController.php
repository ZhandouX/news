...
class SuperAdminNewsFilterController extends Controller
{
    /* ========================================================= */
    /* ====================== FILTER FORM ====================== */
    /* ========================================================= */
    ...
    public function filterByYear()
    {
        ...
        return view('super-admin.news.filter-year', compact('yearList'));
    }
    ...
    public function filterByOffice()
    {
        ...
        return view('super-admin.news.filter-office', compact('officeList'));
    }
    ...
    public function filterBySumber()
    {
        ...
        return view('super-admin.news.filter-sumber', compact('sumberList'));
    }
    ...
    public function filterByMonth()
    {
        ...
        return view('super-admin.news.filter-month', compact('monthList'));
    }
    ...
    {
        $officeList = News::select('office')->distinct()->pluck('office');
        return view('super-admin.news.filter-office-year', compact('officeList'));
    }
    ...
    {
        $sumberList = News::select('sumber')->distinct()->pluck('sumber');
        return view('super-admin.news.filter-sumber-year', compact('sumberList'));
    }
}
